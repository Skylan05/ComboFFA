...
public class ComboFFAListerner implements org.bukkit.event.Listener {
    ...
    public void entityDamageByEntityEvent(EntityDamageByEntityEvent e){
        if (e.getEntity() instanceof Player){
            ...
            damager.setVelocity(e.getDamager().getLocation().getDirection().normalize().multiply(-0.55F));
        }
    }
    ...
    public void onBlockPlaceEvent(BlockPlaceEvent e) {
        if (Bukkit.getWorld("ComboFFA").equals(e.getPlayer().getWorld()))
    ...
    public void onEntityDamage(EntityDamageEvent e) {
        if (Bukkit.getWorld("ComboFFA").equals(e.getEntity().getWorld()))
    ...
    public void PlayerDamageReceive(EntityDamageByEntityEvent e) {
        if (e.getEntity() instanceof Player) {
            ...
            if (e.getDamager() instanceof Player) {
                ...
                if (damaged.getWorld().equals(Bukkit.getWorld("ComboFFA"))) {
    ...
    public void Interact(PlayerInteractEvent e) {
        if (e.getPlayer().getWorld().equals(Bukkit.getWorld("ComboFFA"))) {
    ...
    public void onPlayerDeath(PlayerDeathEvent e) {
        if (e.getEntity().getLocation().getWorld().getName().equals("ComboFFA")) {
    ...
    public void onPlayerRespawn (PlayerRespawnEvent e) {
        Player p = e.getPlayer();
        if (p.getLocation().getWorld().getName().equals("ComboFFA")) {
